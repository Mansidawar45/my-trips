...
//   const imgUrl = f?.Image?.data ? getImageUrl(f.Image.data[0]?.url) : "";
...
//       <h1 className="text-3xl font-bold mb-4">{f.FlightName}</h1>
...
//         <strong>From:</strong> {f.From}
//       </p>

//       <p className="text-lg mb-2">
//         <strong>To:</strong> {f.To}
//       </p>
