...
export interface ApiBusBus extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Bustype: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'BusName'>;
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activities: Schema.Attribute.Relation<
      ...
      'api::activity.activity'
    >;
    averageBudget: Schema.Attribute.Integer;
    ...
    Title: Schema.Attribute.String;
    travel_guides: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFlightFlight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AirlineName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    Duration: Schema.Attribute.String;
    Flightcode: Schema.Attribute.String;
    Image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    Price: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'AirlineName'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hotel.hotel'> &
      Schema.Attribute.Private;
    LocationMapLink: Schema.Attribute.String;
    Name: Schema.Attribute.String;
...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    destination: Schema.Attribute.Relation<
      ...
      'api::destination.destination'
    >;
    EntryFee: Schema.Attribute.Integer;
    Image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTrainTrain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'TrainName'>;
    to: Schema.Attribute.String;
    TrainName: Schema.Attribute.String;
...
export interface ApiTravelPckageTravelPckage
  extends Struct.CollectionTypeSchema {
  collectionName: 'travel_pckages';
  info: {
    displayName: 'TravelPackage';
    pluralName: 'travel-pckages';
    singularName: 'travel-pckage';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::travel-pckage.travel-pckage'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::travel-pckage.travel-pckage': ApiTravelPckageTravelPckage;
